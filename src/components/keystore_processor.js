        ...
        <div>
            ...
            <div>
                <form onSubmit={this.handleSubmit}>
                    <div><lable>keystore: </lable><input type="file" onChange={this.handleKeystoreChange} /></div>
                    <div><label>password: </label><input type="password" onChange={this.handlePasswordChange} /></div>
